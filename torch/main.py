...
from write_tfrecords import process_files
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='process the raw file and generate h5ad records for training')

    parser.add_argument(
        '--train', required=False,
        default=False, action='store_true',
        help='Use the generated h5ad records for training the model')
    ...
    for exp in experiments:
        ...
        if a.process:
            ...
            copytree(raw_input, exp_dir, raw_file_name)
