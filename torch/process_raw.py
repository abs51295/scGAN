...
class GeneMatrix:
    ...
    def read_raw_file(self):
        ...
        andata = sc.read_10x_mtx(self.raw_file)
    ...
    def scaling(self):
        ...
        if "normalize_per_cell_LS_" not in str(self.scale):
        ...
        sc.pp.normalize_total(self.sc_raw,
                              target_sum=lib_size)
    ...
    def split(self):
        ...
        if self.balanced_split:
            ...
            for key in valid_cells_per_cluster:
                ...
                for i in test_indices:
                    self.sc_raw.obs['split'][i] = 'test'

                for i in valid_indices:
                    self.sc_raw.obs['split'][i] = 'valid'
        ...
        train_indices = self.sc_raw.obs[
            self.sc_raw.obs['split'] == 'train'].index
